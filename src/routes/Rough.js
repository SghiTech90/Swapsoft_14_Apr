...
const ReportScreen = ({navigation, route}) => {
  ...
  // ── Call all 15 MASTERHEADWISE APIs ───────────────────────────────────────
...
const styles = StyleSheet.create({
  ...
  cell:               {minWidth: 100, borderRightWidth: 1, borderColor: '#eee', paddingHorizontal: 8, paddingVertical: 6, justifyContent: 'center', alignSelf: 'stretch', backgroundColor: '#fff'},
